...
public class CommandMethods {
	...
	public void spaces() {
		final String RESET = "\033[0m";  
			...
			System.out.println(BLACK_BOLD + WHITE_BACKGROUND + "Collect color sets\n" + Brown + "\t" + BLUE_BACKGROUND_BRIGHT + "\t" + PURPLE_BACKGROUND + "\t" + RED_BACKGROUND_BRIGHT + "\t" + RED_BACKGROUND + "\t" + YELLOW_BACKGROUND + "\t" + GREEN_BACKGROUND + "\t" + BLUE_BACKGROUND + "\t" + WHITE_BACKGROUND);
